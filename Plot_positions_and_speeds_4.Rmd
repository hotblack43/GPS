...
model_motion <- function(df,statname,limitdates)
{
  ...
  for (isegment in 1:(nsegments-1))
  {
    ...
    print(c(anytime(limitdates[isegment,1],asUTC=T),anytime(limitdates[isegment,2],asUTC=T)))
    print(length(jdx))
    #browser()
...
important_times <- c(as.POSIXct("2022-03-31 00:00:00",tz="UTC"),as.POSIXct("2022-04-24 00:00:00",tz="UTC"),
                     ...
                     as.POSIXct("2022-04-27 17:00:00",tz="UTC"),as.POSIXct("2022-05-31 00:00:01",tz="UTC"),
                     as.POSIXct("2022-05-31 00:00:01",tz="UTC"),as.POSIXct("2022-06-09 03:00:00",tz="UTC"),
