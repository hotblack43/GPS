  ...
  
{
  ...
  {
    print(c(ijk,unname(as.POSIXct(unlist(listerne$left_right_dates[ijk,]),origin="1970-01-01 00:00:00",tz="UTC")),segspeeds[ijk]))
    print(c(ijk,unname(as.POSIXct(unlist(listerne$left_right_dates[ijk,]),origin="1970-01-01 00:00:00",tz="UTC")),surge_speeds$speed_jump[ijk,2]))
  }
  print(c(ijk,unname(as.POSIXct(unlist(listerne$left_right_dates[ijk,]),origin="1970-01-01 00:00:00",tz="UTC")),segspeeds[length(segspeeds)]))
}
